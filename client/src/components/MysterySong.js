    ...
    return (
        <div>
            ...
            <div className='relative'>
                ...
                <button onClick={togglePlay} className='absolute top-1/4 left-1/4 '>
