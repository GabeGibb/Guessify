...
function MysterySong({ song, delay}) {
    ...
    return (
        <div>
            ...
            <div className='inline-flex justify-evenly w-full sm:hidden'>
                ...
                <input className='accent-[#D9D9D9] disabled:hover disabled:click' type="range" min="0" max="1" step="0.01" value={volume} onChange={handleVolumeChange} />
            </div>
